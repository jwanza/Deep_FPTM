...
class DeepSTCM_Wrapper(DeepTMNetwork):
    ...
    def __init__(self, n_features, n_clauses, n_classes, tau, **kwargs):
        ...
        super().__init__(
            ...
            layer_extra_kwargs={"ternary_band": ternary_band, "lf": 20}, # Use larger LF here too
            **deep_kwargs
        )
...
def run_experiment():
    print("=== Running SOTA Experiments (MNIST) - RE-RUN 2 (Corrected) ===")
